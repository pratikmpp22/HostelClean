    ...
    <div class="row parent-row">
      ...
      <div class="col s1 l7 hide-on-med-and-down">
        <div class="flex-v-center">
          ...
          <p class="support-text">Enjoy Hassle-Free Room Cleaning at Your Preferred <br>Time with Just a Simple Click!</p>
        </div>
      </div>
      <!-- Form -->
      <div class="col s12 l5">
        <div class="center-align form-align">
          <h4>Sign In</h4>
          <p class="hide-on-large-only">Enjoy Hassle-Free Room Cleaning at Your Preferred <br> Time with Just a Simple Click!</p>
          <div class="row">
